...
var QTags = function(name, id, container, disabled) {
	...
	t.Buttons[t.Buttons.length] = new edButton(name+'_comment1','v','<div style="color:#666;font-size:11px;margin:20px 0px 0px 0px;padding:20px;font-style:italic;border:1px solid #AAA;"><b>Comment:</b><br />','</div>','v');
